...
export const updateFirstApprovedSegAt = (mongo_db, mongo_collection, mongo_uri, path) => {
    MongoClient.connect(mongo_uri, { useNewUrlParser: true }, (err, client) => {
        ...
        readFile(path, "utf8", async (err, data) => {
            ...
            for (let row of recordsWithoutHeader) {
                ...
                let firstApprovedSegString = row[1]
                let firstApprovedSeg = new Date(firstApprovedSegString)
                ...
                updateArray.push({
                    updateOne: {
                        ...
                        update: {
                            $set: {
                                "account.first_approved_seg_at": firstApprovedSeg,
